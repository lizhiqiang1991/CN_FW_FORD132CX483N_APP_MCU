...
__attribute__((section (".user_RAM"))) uint32_t pUpdateKey;
#if (U717_TDDI_NT51926) /*H-04.05.00*/
	const uint8_t mu8Core[] = { "RU5T-14F180-SC" };
	const uint8_t mu8Soft[] = { "RU5T-14D358-SC" };
	const uint8_t mu8Main[] = { "RU5T-14D359-SC" };    
#elif(CX430_TDDI_NT51926) /*F-04.06.00*/
	//const uint8_t mu8Core[] = { "SU5T-14F180-PC" };
	//const uint8_t mu8Soft[] = { "SU5T-14D358-PC" };
	//const uint8_t mu8Main[] = { "SU5T-14D359-PC" };

	const uint8_t mu8Core[] = { "VJ7T-14F180-AA" };//Core Assembly  0x31
	const uint8_t mu8Soft[] = { "VJ7T-14D358-AA" };//software ford part Number0x33
	const uint8_t mu8Main[] = { "VJ7T-14D359-AA" };//main Calibration ford part number 0x35
	//const uint8_t mu8Delivery[]={"VJ7T-18B955-AA"};//Delivery Assembly 0x32
