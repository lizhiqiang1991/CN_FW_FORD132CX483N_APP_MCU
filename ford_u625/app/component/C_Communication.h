...
#define EVENT_MESSAGE_TD7800_REG_READY	    EVENT_MESSAGE1
#define EVENT_MESSAGE_START_INTB_STRATEGY	EVENT_MESSAGE2
#define EVENT_MESSAGE_CANCEL_INTB_STRATEGY	EVENT_MESSAGE3
